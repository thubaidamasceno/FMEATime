...
export const rh = (verb, url, body) => {
    switch (verb) {
        case 'post':
            return superagent.post(`${window.API_ROOT}${url}`, body);
        case 'put':
            return superagent.put(`${window.API_ROOT}${url}`, body);
        case 'patch':
            return superagent.patch(`${window.API_ROOT}${url}`, body);
        case 'del':
            return superagent.del(`${window.API_ROOT}${url}`);
        case 'head':
            return superagent.head(`${window.API_ROOT}${url}`);
        case 'get':
            return superagent.get(`${window.API_ROOT}${url}`);
        default:
